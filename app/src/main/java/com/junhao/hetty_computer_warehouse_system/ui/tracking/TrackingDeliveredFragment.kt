...
class TrackingDeliveredFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_tracking_delivered, container, false)
                                ...
                                if(snapshot2!!.exists()) {
                                    ...
                                    for (w in snapshot2.children){
                                        ...
                                        if(warehouseBarCode == barCode){
                                            ...
                                            if(warehouseInvStatus == "Delivered"){
                                    ...
                                    val recyclerView: RecyclerView = view.findViewById(R.id.trackingItemRecycleViewDelivered)
